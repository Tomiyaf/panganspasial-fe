  ...
  return (
    <div className="pt-24 pb-20 min-h-[100dvh] bg-slate-50 text-slate-800 font-body">
      <div className="max-w-5xl mx-auto px-6 lg:px-8 space-y-14">
        ...
        {/* Main Narrative Card */}
        <div className="p-8 sm:p-12 rounded-3xl bg-white border border-slate-200/90 shadow-xs space-y-6">
          <div className="space-y-4 leading-relaxed text-sm sm:text-base text-slate-600">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {dataSources.map((ds, idx) => (
              <div key={idx} className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs space-y-2">
                <span className="text-xs font-bold font-heading text-[#2E7D32]">
                  0{idx + 1}
                </span>
        ...
        <div className="p-8 rounded-2xl bg-slate-900 text-white flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/spasial"
            className="px-6 py-3 rounded-lg bg-[#2E7D32] hover:bg-[#236327] text-white text-xs font-semibold font-heading transition-colors shrink-0 inline-flex items-center gap-2 shadow-md"
          >
